...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-17 08:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/855defb3-35d9-4ef9-b538-c29770ce3c7b.git
$ cd 855defb3-35d9-4ef9-b538-c29770ce3c7b
```
